...
public class JmxConnection {
    ...
    public void printController() throws IntrospectionException, ReflectionException, InstanceNotFoundException, IOException, MalformedObjectNameException {
        String objectNamestr = getController();
        ObjectName objectName = null;
        ...
        for (MBeanAttributeInfo mBeanAttributeInfo: mBeanAttributeInfos){
            ...
            System.out.println( mBeanAttributeInfo.getType() );
            System.out.println( mBeanAttributeInfo.getDescription() );
            String[] fieldNames = mBeanAttributeInfo.getDescriptor().getFieldNames();
            for (String fieldName: fieldNames ){
                System.out.println( fieldName );
            }
        }
        String[] fieldNames = mBeanInfo.getDescriptor().getFieldNames();
        for (String fieldName: fieldNames ){
            System.out.println( fieldName );
        }
